    ...
    <section className="hero" id="home">
      ...
      <div className="hero__right">
        <div className="hero__avatar-wrap">
          ...
          {/* blob layer 1 — large outer glow, blurred */}
          <div className="hero__blob" />

          {/* blob layer 2 — tighter inner layer, different morph timing */}
          <div className="hero__blob-2" />

          {/* picture frame — same blob-morph shape as the blobs, sits on top */}
